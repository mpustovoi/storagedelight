...
{
    private static final Component DEFAULT_NAME = Component.translatable("container.storagedelight.glass_cabinet");
    private NonNullList<ItemStack> items;
    private final ContainerOpenersCounter openersCounter;

    public GlassCabinetBlockEntity(BlockPos pos, BlockState blockState) {
        super(EntityTypesRegistry.GLASS_CABINET.get(), pos, blockState);
        this.items = NonNullList.withSize(27, ItemStack.EMPTY);
        this.openersCounter = new ContainerOpenersCounter() {
            protected void onOpen(Level p_155062_, BlockPos p_155063_, BlockState p_155064_) {
                GlassCabinetBlockEntity.this.playSound(p_155064_, SoundEvents.WOODEN_TRAPDOOR_OPEN);
                GlassCabinetBlockEntity.this.updateBlockState(p_155064_, true);
            }

            protected void onClose(Level p_155072_, BlockPos p_155073_, BlockState p_155074_) {
                GlassCabinetBlockEntity.this.playSound(p_155074_, SoundEvents.WOODEN_TRAPDOOR_CLOSE);
                GlassCabinetBlockEntity.this.updateBlockState(p_155074_, false);
            }
    ...
    void playSound(BlockState state, SoundEvent sound) {
        Vec3i vec3i = ((Direction)state.getValue(GlassCabinetBlock.FACING)).getUnitVec3i();
