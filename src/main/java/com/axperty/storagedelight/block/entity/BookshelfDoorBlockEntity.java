...
public class BookshelfDoorBlockEntity extends RandomizableContainerBlockEntity
{
    ...
    public BookshelfDoorBlockEntity(BlockPos p_155052_, BlockState p_155053_) {
        super(BlockEntityTypesRegistry.BOOKSHELF_DOOR.get(), p_155052_, p_155053_);
        this.items = NonNullList.withSize(27, ItemStack.EMPTY);
        this.openersCounter = new ContainerOpenersCounter() {
            protected void onOpen(Level p_155062_, BlockPos p_155063_, BlockState p_155064_) {
                BookshelfDoorBlockEntity.this.playSound(p_155064_, SoundEvents.WOODEN_TRAPDOOR_OPEN);
                BookshelfDoorBlockEntity.this.updateBlockState(p_155064_, true);
            }

            protected void onClose(Level p_155072_, BlockPos p_155073_, BlockState p_155074_) {
                BookshelfDoorBlockEntity.this.playSound(p_155074_, SoundEvents.WOODEN_TRAPDOOR_CLOSE  );
                BookshelfDoorBlockEntity.this.updateBlockState(p_155074_, false);
            }
            ...
            protected boolean isOwnContainer(Player p_155060_) {
                if (p_155060_.containerMenu instanceof ChestMenu) {
                    ...
                    return $$1 == BookshelfDoorBlockEntity.this;
                } else {
                    return false;
                }
            }
    ...
    protected Component getDefaultName() {
        return Component.translatable("container.storagedelight.bookshelf_door");
    }
    ...
    void updateBlockState(BlockState p_58607_, boolean p_58608_) {
        this.level.setBlock(this.getBlockPos(), (BlockState)p_58607_.setValue(BookshelfDoorBlock.OPEN, p_58608_), 3);
    }

    void playSound(BlockState p_58601_, SoundEvent p_58602_) {
        Vec3i $$2 = ((Direction)p_58601_.getValue(BookshelfDoorBlock.FACING)).getNormal();
