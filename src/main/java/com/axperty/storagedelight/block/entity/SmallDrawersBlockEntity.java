...
public class SmallDrawersBlockEntity extends RandomizableContainerBlockEntity
{
    ...
    private ContainerOpenersCounter openersCounter = new ContainerOpenersCounter()
    {
        ...
        protected boolean isOwnContainer(Player p_155060_) {
            if (p_155060_.containerMenu instanceof ChestMenu) {
                ...
                return container == SmallDrawersBlockEntity.this;
            } else {
                return false;
            }
        }
    ...
    public SmallDrawersBlockEntity(BlockPos pos, BlockState state) {
        super(EntityTypesRegistry.SMALL_DRAWERS.get(), pos, state);
    }
    ...
    void updateBlockState(BlockState state, boolean open) {
        if (level != null) {
            this.level.setBlock(this.getBlockPos(), state.setValue(SmallDrawersBlock.OPEN, open), 3);
        }
    }
    ...
    private void playSound(BlockState state, SoundEvent sound) {
        ...
        Vec3i drawerFacingVector = state.getValue(SmallDrawersBlock.FACING).getNormal();
