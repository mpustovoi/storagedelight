...
public class SmallDrawersBlockEntity extends RandomizableContainerBlockEntity
{
    ...
    public SmallDrawersBlockEntity(BlockPos p_155052_, BlockState p_155053_) {
        super(EntityTypesRegistry.SMALL_DRAWERS.get(), p_155052_, p_155053_);
        ...
        this.openersCounter = new ContainerOpenersCounter() {
            ...
            protected boolean isOwnContainer(Player p_155060_) {
                if (p_155060_.containerMenu instanceof ChestMenu) {
                    ...
                    return $$1 == SmallDrawersBlockEntity.this;
                } else {
                    return false;
                }
            }
    ...
    void updateBlockState(BlockState p_58607_, boolean p_58608_) {
        this.level.setBlock(this.getBlockPos(), (BlockState)p_58607_.setValue(SmallDrawersBlock.OPEN, p_58608_), 3);
    }

    void playSound(BlockState p_58601_, SoundEvent p_58602_) {
        Vec3i $$2 = ((Direction)p_58601_.getValue(SmallDrawersBlock.FACING)).getNormal();
