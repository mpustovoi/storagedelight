...
//
//    public CabinetBlockEntity(BlockPos p_155052_, BlockState p_155053_) {
//        super(EntityTypesRegistry.CABINET.get(), p_155052_, p_155053_);
...
//                    return $$1 == CabinetBlockEntity.this;
//                } else {
//                    return false;
//                }
//            }
...
//        return Component.translatable("container.storagedelight.cabinet");
//    }
//
...
//        this.level.setBlock(this.getBlockPos(), (BlockState)p_58607_.setValue(CabinetBlock.OPEN, p_58608_), 3);
//    }
//
//    void playSound(BlockState p_58601_, SoundEvent p_58602_) {
//        Vec3i $$2 = ((Direction)p_58601_.getValue(CabinetBlock.FACING)).getNormal();
