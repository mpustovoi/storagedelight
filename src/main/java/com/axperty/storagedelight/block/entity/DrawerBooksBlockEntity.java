...
public class DrawerBooksBlockEntity extends RandomizableContainerBlockEntity
{
    ...
    void updateBlockState(BlockState p_58607_, boolean p_58608_) {
        this.level.setBlock(this.getBlockPos(), p_58607_.setValue(DrawerBooksBlock.OPEN, p_58608_), 3);
    }

    void playSound(BlockState p_58601_, SoundEvent p_58602_) {
        Vec3i vec3i = p_58601_.getValue(DrawerBooksBlock.FACING).getUnitVec3i();
