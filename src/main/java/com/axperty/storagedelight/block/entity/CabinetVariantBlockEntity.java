...
public class CabinetVariantBlockEntity extends RandomizableContainerBlockEntity
{
        ...
        this.openersCounter = new ContainerOpenersCounter() {
            ...
            protected boolean isOwnContainer(Player p_155060_) {
                if (p_155060_.containerMenu instanceof ChestMenu) {
                    ...
                    return $$1 == CabinetVariantBlockEntity.this;
                } else {
                    return false;
                }
            }
    ...
    void updateBlockState(BlockState p_58607_, boolean p_58608_) {
        this.level.setBlock(this.getBlockPos(), (BlockState)p_58607_.setValue(CabinetVariantBlock.OPEN, p_58608_), 3);
    }

    void playSound(BlockState p_58601_, SoundEvent p_58602_) {
        Vec3i $$2 = ((Direction)p_58601_.getValue(CabinetVariantBlock.FACING)).getNormal();
