...
//
//public class CabinetBlock extends InventoryBlockWithEntity {
...
//                player.openHandledScreen((CabinetBlockEntity)blockEntity);
...
//            BlockEntity blockEntity = world.getBlockEntity(pos);
//            if (blockEntity instanceof CabinetBlockEntity) {
//                ((CabinetBlockEntity)blockEntity).setCustomName(itemStack.getName());
//            }
//        }
//
//    }
