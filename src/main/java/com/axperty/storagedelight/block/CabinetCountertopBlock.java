...
public class CabinetCountertopBlock extends InventoryBlockWithEntity {
    public static final MapCodec<CabinetCountertopBlock> CODEC = createCodec(CabinetCountertopBlock::new);
    public static final DirectionProperty FACING = Properties.HORIZONTAL_FACING;
    public static final BooleanProperty OPEN = Properties.OPEN;

    public MapCodec<CabinetCountertopBlock> getCodec() {
        return CODEC;
    }
    ...
    public CabinetCountertopBlock(Settings settings) {
        super(settings);
    ...
    public ActionResult onUse(BlockState state, World world, BlockPos pos, PlayerEntity player, Hand hand, BlockHitResult hit) {
        if (world.isClient) {
            ...
            if (blockEntity instanceof CabinetCountertopBlockEntity) {
                player.openHandledScreen((CabinetCountertopBlockEntity)blockEntity);
    ...
    public void onPlaced(World world, BlockPos pos, BlockState state, @Nullable LivingEntity placer, ItemStack itemStack) {
        if (itemStack.hasCustomName()) {
            BlockEntity blockEntity = world.getBlockEntity(pos);
            if (blockEntity instanceof CabinetCountertopBlockEntity) {
                ((CabinetCountertopBlockEntity)blockEntity).setCustomName(itemStack.getName());
            }
        }
