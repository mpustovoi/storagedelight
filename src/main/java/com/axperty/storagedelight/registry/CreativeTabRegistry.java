...
public class CreativeTabRegistry
{
    ...
    public static final RegistryObject<CreativeModeTab> STORAGEDELIGHT_TAB = CREATIVE_MODE_TABS.register(StorageDelight.MOD_ID, () -> CreativeModeTab.builder()
            ...
            .displayItems((parameters, output) -> {
                ...
                output.accept(BlockRegistry.OAK_CABINET_WITH_STONE_BRICKS_COUNTERTOP.get());
...
//              output.accept(BlockRegistry.OAK_PANTRY_CABINET.get());
                ...
                output.accept(BlockRegistry.WARPED_CABINET_WITH_STONE_BRICKS_COUNTERTOP.get());
            }).build());
}