...
//        public static final RegistryObject<Block> OAK_PANTRY_CABINET = BLOCKS.register("oak_pantry_cabinet",
//                () -> new PantryCabinetBlock(Block.Properties.ofFullCopy(Blocks.BARREL)
//                        .setId(BLOCKS.key("oak_pantry_cabinet"))));
