...
public class BlockRegistry {
    ...
    public static final DeferredBlock<Block> CHERRY_DRAWER_WITH_BOOKS = BLOCKS.register("cherry_drawer_with_books",
            registryName -> new DrawerBooksBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BARREL).sound(SoundType.CHERRY_WOOD).setId(ResourceKey.create(Registries.BLOCK, registryName)))); // Added sound consistent with other Cherry items
    ...
    public static final DeferredBlock<Block> CHERRY_BOOKSHELF_WITH_DOOR = BLOCKS.register("cherry_bookshelf_with_door",
            registryName -> new BookshelfDoorBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.BARREL).sound(SoundType.CHERRY_WOOD).setId(ResourceKey.create(Registries.BLOCK, registryName)))); // Added sound consistent with other Cherry items
