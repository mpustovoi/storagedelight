...
public class EntityTypesRegistry {
    ...
    // Drawers with Books
    public static final Supplier<BlockEntityType<DrawerBooksBlockEntity>> DRAWER_BOOKS = TILES.register("drawer_books",
    ...
    // Cabinets with Glass Doors and Cabinets with Door Cabinets
    ...
    public static final Supplier<BlockEntityType<BookshelfDoorBlockEntity>> BOOKSHELF_DOOR = TILES.register("bookshelf_door",
    ...
    // Small Drawers
    public static final Supplier<BlockEntityType<SmallDrawersBlockEntity>> SMALL_DRAWERS = TILES.register("small_drawers",
    ...
    public static final Supplier<BlockEntityType<CabinetCountertopBlockEntity>> COUNTERTOP = TILES.register("countertop",
