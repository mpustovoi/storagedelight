...
public class EntityTypesRegistry {
    ...
    public static final Supplier<BlockEntityType<CabinetCountertopBlockEntity>> COUNTERTOP = BLOCK_ENTITY_TYPES.register("countertop",
            () -> new BlockEntityType<>(CabinetCountertopBlockEntity::new,
                    ...
                    BlockRegistry.OAK_CABINET_WITH_POLISHED_GRANITE_COUNTERTOP.get(),
                    BlockRegistry.BIRCH_CABINET_WITH_POLISHED_GRANITE_COUNTERTOP.get(),
                    BlockRegistry.SPRUCE_CABINET_WITH_POLISHED_GRANITE_COUNTERTOP.get(),
                    BlockRegistry.JUNGLE_CABINET_WITH_POLISHED_GRANITE_COUNTERTOP.get(),
                    BlockRegistry.ACACIA_CABINET_WITH_POLISHED_GRANITE_COUNTERTOP.get(),
                    BlockRegistry.DARK_OAK_CABINET_WITH_POLISHED_GRANITE_COUNTERTOP.get(),
                    BlockRegistry.MANGROVE_CABINET_WITH_POLISHED_GRANITE_COUNTERTOP.get(),
                    BlockRegistry.CHERRY_CABINET_WITH_POLISHED_GRANITE_COUNTERTOP.get(),
                    BlockRegistry.PALE_OAK_CABINET_WITH_POLISHED_GRANITE_COUNTERTOP.get(),
                    BlockRegistry.BAMBOO_CABINET_WITH_POLISHED_GRANITE_COUNTERTOP.get(),
                    BlockRegistry.CRIMSON_CABINET_WITH_POLISHED_GRANITE_COUNTERTOP.get(),
                    BlockRegistry.WARPED_CABINET_WITH_POLISHED_GRANITE_COUNTERTOP.get())
    );
