...
public enum ItemRegistry {
    ...
    SMALL_CHERRY_DRAWERS("small_cherry_drawers", () -> new ModBlockItem(BlockRegistry.SMALL_CHERRY_DRAWERS.get())),
    CHERRY_BOOKSHELF_WITH_DOOR("cherry_bookshelf_with_door", () -> new ModBlockItem(BlockRegistry.CHERRY_BOOKSHELF_WITH_DOOR.get())),
    ...
    SMALL_BAMBOO_DRAWERS("small_bamboo_drawers", () -> new ModBlockItem(BlockRegistry.SMALL_BAMBOO_DRAWERS.get())),
    BAMBOO_BOOKSHELF_WITH_DOOR("bamboo_bookshelf_with_door", () -> new ModBlockItem(BlockRegistry.BAMBOO_BOOKSHELF_WITH_DOOR.get())),
