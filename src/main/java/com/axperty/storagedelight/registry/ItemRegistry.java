...
public class ItemRegistry {
    ...
    public static final DeferredItem<BlockItem> OAK_CABINET_WITH_POLISHED_GRANITE_COUNTERTOP = ITEMS.registerSimpleBlockItem("oak_cabinet_with_polished_granite_countertop", BlockRegistry.OAK_CABINET_WITH_POLISHED_GRANITE_COUNTERTOP, Item.Properties::new);
    ...
    public static final DeferredItem<BlockItem> BIRCH_CABINET_WITH_POLISHED_GRANITE_COUNTERTOP = ITEMS.registerSimpleBlockItem("birch_cabinet_with_polished_granite_countertop", BlockRegistry.BIRCH_CABINET_WITH_POLISHED_GRANITE_COUNTERTOP, Item.Properties::new);
    ...
    public static final DeferredItem<BlockItem> SPRUCE_CABINET_WITH_POLISHED_GRANITE_COUNTERTOP = ITEMS.registerSimpleBlockItem("spruce_cabinet_with_polished_granite_countertop", BlockRegistry.SPRUCE_CABINET_WITH_POLISHED_GRANITE_COUNTERTOP, Item.Properties::new);
    ...
    public static final DeferredItem<BlockItem> JUNGLE_CABINET_WITH_POLISHED_GRANITE_COUNTERTOP = ITEMS.registerSimpleBlockItem("jungle_cabinet_with_polished_granite_countertop", BlockRegistry.JUNGLE_CABINET_WITH_POLISHED_GRANITE_COUNTERTOP, Item.Properties::new);
    ...
    public static final DeferredItem<BlockItem> ACACIA_CABINET_WITH_POLISHED_GRANITE_COUNTERTOP = ITEMS.registerSimpleBlockItem("acacia_cabinet_with_polished_granite_countertop", BlockRegistry.ACACIA_CABINET_WITH_POLISHED_GRANITE_COUNTERTOP, Item.Properties::new);
    ...
    public static final DeferredItem<BlockItem> DARK_OAK_CABINET_WITH_POLISHED_GRANITE_COUNTERTOP = ITEMS.registerSimpleBlockItem("dark_oak_cabinet_with_polished_granite_countertop", BlockRegistry.DARK_OAK_CABINET_WITH_POLISHED_GRANITE_COUNTERTOP, Item.Properties::new);
    ...
    public static final DeferredItem<BlockItem> MANGROVE_CABINET_WITH_POLISHED_GRANITE_COUNTERTOP = ITEMS.registerSimpleBlockItem("mangrove_cabinet_with_polished_granite_countertop", BlockRegistry.MANGROVE_CABINET_WITH_POLISHED_GRANITE_COUNTERTOP, Item.Properties::new);
    ...
    public static final DeferredItem<BlockItem> CHERRY_CABINET_WITH_POLISHED_GRANITE_COUNTERTOP = ITEMS.registerSimpleBlockItem("cherry_cabinet_with_polished_granite_countertop", BlockRegistry.CHERRY_CABINET_WITH_POLISHED_GRANITE_COUNTERTOP, Item.Properties::new);
    ...
    public static final DeferredItem<BlockItem> PALE_OAK_CABINET_WITH_POLISHED_GRANITE_COUNTERTOP = ITEMS.registerSimpleBlockItem("pale_oak_cabinet_with_polished_granite_countertop", BlockRegistry.PALE_OAK_CABINET_WITH_POLISHED_GRANITE_COUNTERTOP, Item.Properties::new);
    ...
    public static final DeferredItem<BlockItem> BAMBOO_CABINET_WITH_POLISHED_GRANITE_COUNTERTOP = ITEMS.registerSimpleBlockItem("bamboo_cabinet_with_polished_granite_countertop", BlockRegistry.BAMBOO_CABINET_WITH_POLISHED_GRANITE_COUNTERTOP, Item.Properties::new);
    ...
    public static final DeferredItem<BlockItem> CRIMSON_CABINET_WITH_POLISHED_GRANITE_COUNTERTOP = ITEMS.registerSimpleBlockItem("crimson_cabinet_with_polished_granite_countertop", BlockRegistry.CRIMSON_CABINET_WITH_POLISHED_GRANITE_COUNTERTOP, Item.Properties::new);
    ...
    public static final DeferredItem<BlockItem> WARPED_CABINET_WITH_POLISHED_GRANITE_COUNTERTOP = ITEMS.registerSimpleBlockItem("warped_cabinet_with_polished_granite_countertop", BlockRegistry.WARPED_CABINET_WITH_POLISHED_GRANITE_COUNTERTOP, Item.Properties::new);
}